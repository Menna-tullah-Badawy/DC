...
//                    location.isEmpty() || mobile.isEmpty() || site.isEmpty() || specialization.isEmpty() || email.isEmpty() -> {
...
//                    saveDoctorDataInPreferences(name, email, address, mobile, specialization)
//
...
//    }
//
//    private fun saveDoctorDataInPreferences(name: String, email: String, address: String, mobile: String, specialization: String) {
